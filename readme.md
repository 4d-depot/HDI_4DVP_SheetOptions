# How do I manage sheet options

How do I manage sheet options in 4D View Pro (4D v18 R3)

Find more information on the [blog post](https://blog.4d.com/4d-view-pro-more-options-to-customize-your-worksheets/).
